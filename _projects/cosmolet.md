...
<section class="section" style="background-color: var(--bg-secondary);">
    ...
    <h3>Community and Support</h3>
        ...
        <div class="buttons" style="margin-top: 20px;">
            <a href="https://github.com/platformbuilds/cosmolet" style="display: inline-block; background-color: var(--bg-primary); color: var(--text-color); padding: 10px 20px; text-decoration: none; border-radius: 5px; margin-right: 10px;">
            ...
            <a href="/contact/" style="display: inline-block; background-color: var(--bg-primary); color: var(--text-color); padding: 10px 20px; text-decoration: none; border-radius: 5px;">
                Get Started
            </a>
        </div>
    </div>
